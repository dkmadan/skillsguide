...
export const compassSteps: { title: string; description: string; questions: Question[] }[] = [
  { title: 'Your starting point', description: 'Every background has a path forward. Let’s start with yours.', questions: [
    { id: 'education', label: 'Highest education', options: ['12th or below', 'Diploma / ITI', 'B.Com / BBA', 'B.Tech / BCA / MCA', 'BA / Humanities', 'B.Sc / Other degree'] },
    { id: 'experience', label: 'Total work experience', options: ['Fresher', 'Under 2 years', '2–5 years', '5+ years'] },
    { id: 'domain', label: 'Current or most familiar field', options: ['Still exploring', 'Technology', 'Finance / Accounts', 'Marketing / Sales', 'Design / Media', 'Customer operations'] },
  ...
  { title: 'What draws you in', description: 'Find work that fits your interests as well as your skills.', questions: [
    { id: 'interest', label: 'Which work sounds most interesting?', options: ['Finding insights in data', 'Building software', 'Growing a business', 'Creating visual stories', 'Managing money', 'Helping customers', 'Keeping systems reliable'] },
    ...
    { id: 'tools', label: 'Your strongest existing tool', options: ['None yet', 'Excel / Sheets', 'SQL / Power BI', 'Python / JavaScript', 'Figma / Adobe / Video tools', 'Tally / Accounting tools', 'CRM / Marketing tools'] },
...
export const compassTracks: Track[] = [
  ...
  { title: 'Digital Marketing', slug: 'digital-marketing', domain: 'Marketing / Sales', interest: 'Growing a business', tools: 'CRM / Marketing tools', education: 'B.Com / BBA', strengths: { coding: 0, maths: 2, communication: 4, creative: 3, analysis: 3, detail: 2, english: 3 }, hours: 180, salary: [2.8, 5], skills: ['SEO', 'Copywriting', 'Campaign analytics', 'Audience research', 'Experiment design'], projects: ['Audit a local business website and create an SEO plan', 'Build a four-week content calendar with sample posts', 'Design a campaign and measurement dashboard using sample data'], remote: true, freelance: true, people: true, structured: false, stretch: 'Product Growth', stretchSlug: 'product-management' },
  { title: 'Visual & UI Design', slug: 'graphic-figma', domain: 'Design / Media', interest: 'Creating visual stories', tools: 'Figma / Adobe / Video tools', education: 'BA / Humanities', strengths: { coding: 0, maths: 1, communication: 3, creative: 4, analysis: 2, detail: 4, english: 2 }, hours: 240, salary: [3, 6], skills: ['Figma', 'Typography', 'Accessibility', 'User research', 'Prototyping'], projects: ['Redesign a local service landing page', 'Create a reusable accessible UI component kit', 'Prototype a booking flow and test it with five people'], remote: true, freelance: true, people: false, structured: false, stretch: 'Product Design', stretchSlug: 'product-management' },
  { title: 'Accounting & GST', slug: 'tally-gst', domain: 'Finance / Accounts', interest: 'Managing money', tools: 'Tally / Accounting tools', education: 'B.Com / BBA', strengths: { coding: 0, maths: 3, communication: 2, creative: 0, analysis: 2, detail: 4, english: 1 }, hours: 150, salary: [2.4, 4], skills: ['Bookkeeping', 'Tally', 'Excel', 'GST fundamentals', 'Reconciliation'], projects: ['Create a mock company ledger with 30 transactions', 'Reconcile a sample bank statement against the ledger', 'Prepare a practice monthly accounts and tax summary'], remote: false, freelance: true, people: false, structured: true, stretch: 'Financial Analytics', stretchSlug: 'data-analytics' },
  ...
  { title: 'Cloud & DevOps', slug: 'devops-sre', domain: 'Technology', interest: 'Keeping systems reliable', tools: 'Python / JavaScript', education: 'B.Tech / BCA / MCA', strengths: { coding: 3, maths: 2, communication: 2, creative: 1, analysis: 4, detail: 4, english: 3 }, hours: 400, salary: [4, 7.5], skills: ['Linux', 'Networking', 'Docker', 'CI/CD', 'Cloud monitoring'], projects: ['Configure and secure a local Linux server', 'Containerise an app and automate tests in CI', 'Deploy a monitored service with a documented recovery drill'], remote: true, freelance: false, people: false, structured: true, stretch: 'Cloud Architecture', stretchSlug: 'cloud-computing' },
  { title: 'Video Editing', slug: 'video-editing', domain: 'Design / Media', interest: 'Creating visual stories', tools: 'Figma / Adobe / Video tools', education: 'BA / Humanities', strengths: { coding: 0, maths: 0, communication: 2, creative: 4, analysis: 1, detail: 4, english: 1 }, hours: 160, salary: [2.5, 4.8], skills: ['Editing workflow', 'Pacing', 'Sound', 'Colour correction', 'Client briefs'], projects: ['Edit a 60-second story from freely licensed footage', 'Turn a practice interview into three captioned clips', 'Produce a mock brand video with a revision log'], remote: true, freelance: true, people: false, structured: false, stretch: 'Creative Freelancing', stretchSlug: 'freelancing-usd' },
];
...
export function rankCareers(a: Answers) {
  ...
  return compassTracks.map(track => {
    ...
    const salaryFit = Math.min(1, track.salary[1] / Number(a.target.replace(/[^0-9]/g, '')));
    ...
    const constraints = [workFit, employmentFit, a.relocate === 'No' && !track.remote ? .5 : 1, a.risk === 'Need predictability' && a.employment === 'Freelance / Contract' ? .3 : 1, a.budget === 'Free resources only' && track.slug === 'devops-sre' ? .6 : 1, access, a.shifts === 'Daytime only' && ['devops-sre', 'bpo-support'].includes(track.slug) ? .5 : 1];
